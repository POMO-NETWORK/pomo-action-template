...
class Logger:
    ...
    @classmethod
    def log(cls, level, handle, payload, response, message, log_user: str = "system"):
        ...
        cls.__logger.log(
            ...
            extra={
                ...
                "handle": handle,
                "obj": cls.__form_obj(payload, response, log_user=log_user)
            })

    @staticmethod
    def __form_obj(payload: Any, response: Any, log_user: str = "system"):
